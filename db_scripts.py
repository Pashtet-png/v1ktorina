...
def add_questions():
    questions = [
        ('Сколько месяцев в году имеют 28 дней?', 'Все', 'Один', 'Ыыы', 'Два'),
        ...
        ('Что не имеет длины, глубины, ширины, высоты, а можно измерить?', 'Время', 'Глупость', 'Гнилые пороги на БНВ', 'Воздух'),
...
def get_question(last_id=0, vict_id=1):
